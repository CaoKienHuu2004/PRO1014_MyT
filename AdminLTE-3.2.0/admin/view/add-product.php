...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="index.php?page=query_add_product" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="form-group mt-1 d-flex justify-content-center">
                        <img class="preview" src="#" alt="Xem trước ảnh" style="max-width: 200px; max-height: 200px; display: none;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="discount" id="discount" class="form-control" placeholder="Khuyễn mãi (nhập số phần trăm)">
                        <div class="input-group-append">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
