...
INSERT INTO `cart` (`idCart`, `idProducts`, `idOrder`, `Total_price`) VALUES
(1, 3, 1, 25),
(2, 8, 1, 0);
...
INSERT INTO `order` (`idOrder`, `idUser`, `Name_seller`, `Phone_seller`, `Email_seller`, `Name_buyer`, `Phone_buyer`, `Email_buyer`, `Date_oder`, `Payments`, `Total_Pcion`, `Check_out`) VALUES
(1, 3, 'Quản Trị Viên', 0, 'lyhuu5570@gmail.com', 'Đặng Trung Đức', 0, 'không có', '2023-12-03 23:39:59', 'PCoin', 25, 1);
...
(1, 'lyhuu123', '13102004caokienhuu', 'client-3.png', 'Cao Kiến Hựu', 'lyhuu5570@gmail.com', 374244751, NULL, NULL, NULL, 0, 20),
(2, 'admin', '321', 'boy-avater.png', 'Quản Trị Viên', 'quantrivien@gmail.com', 374244751, 'TP.HCM', 'Lập Trình Viên + Nhà điều hành MyT Việt Nam', 'Web Dev', 1, 320),
(3, 'duclee206', '1234', '/newUser/AvatarBase.jpg', 'Đặng Trung Đức', 'duclee206145@gmail.com', 0, NULL, NULL, NULL, 0, 120);
