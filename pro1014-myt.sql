...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 19, 2023 lúc 06:52 AM
...
(0, 'Công nghệ Thông Tin', NULL),
(1, 'Thiết kế đồ họa', NULL);
...
CREATE TABLE `user` (
  ...
  `Avata_img` varchar(100) NOT NULL,
